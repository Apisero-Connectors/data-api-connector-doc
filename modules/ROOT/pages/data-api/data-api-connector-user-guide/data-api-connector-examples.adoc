...
After successful execution we get the search results for promotion campaign assignments. 
...
[start = 2]
. Add Operation, "Assignment Search" operation from the palatte to the flow.
